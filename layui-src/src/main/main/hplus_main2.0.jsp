...
<head>
  ...
  <link rel="shortcut icon" href="images/favicon.ico">
   <link href="plug-in/assets/css/asidenav.css" rel="stylesheet">
...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
      <div class="row border-bottom">
        <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
          <div class="navbar-header" style="height: 40px;width:inherit!important;"><a
              class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i>
            </a>
            <form role="search" class="navbar-form-custom" method="post" action="search_results.html">
              <div class="form-group">
                <input type="text" placeholder="欢迎使用ILIS …" class="form-control" name="top-search" id="top-search">
              </div>
            </form>
          </div>
            ...
            <li class="dropdown" onfocus="bindFrameClick()">
              ...
              <ul class="dropdown-menu dropdown-alerts">
                ...
                <li>
                  ...
                  <t:mutiLang langKey="common.profile" /></a></li>
               <%--  <li>
                  <a href="javascript:openwindow('<t:mutiLang langKey="common.ssms.getSysInfos" />','tSSmsController.do?getSysInfos')">
                  <t:mutiLang langKey="common.ssms.getSysInfos" /></a></li>
                <li>
                  <a href="javascript:add('<t:mutiLang langKey="common.change.style" />','userController.do?changestyle','',550,250)">
                  <t:mutiLang langKey="common.my.style" /></a></li> --%>
                <li><a href="javascript:clearLocalstorage()">
                    <t:mutiLang langKey="common.clear.localstorage" /></a></li>
              <!--   <li><a href="javascript:toJeecgYun()">云应用中心</a></li> -->
                <li><a href="http://help.qdm123.com/" target="_Blank">帮助系统</a></li>
                <!-- <li><a href="http://yun.jeecg.org" target="_blank">云应用中心</li> -->
                <!--  <li class="divider"></li>
                             <li><a href="javascript:logout()">注销</a></li> -->
              </ul>
      ...
      <div class="row content-tabs">
        ...
        <nav class="page-tabs J_menuTabs">
          <div class="page-tabs-content">
            ...
            <a href="javascript:;" class="active J_menuTab" data-id="homePageController.do?goHomePage">首页</a>
          </div>
          <button class="roll-nav roll-right J_tabRight" style="right: 90px;">
            <i class="fa fa-forward"></i>
          </button>
          <div class="btn-group roll-nav roll-right">
            <button class="dropdown J_tabClose" data-toggle="dropdown" style="right:20px;">
      ...
      <div class="row J_mainContent" id="content-main" style="margin-left:-13px;">
        ...
        <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="homePageController.do?goHomePage"
          frameborder="0" data-id="homePageController.do?goHomePage" seamless></iframe>
      </div>
      <div class="footer">
        <div class="pull-right">&copy; <%-- <t:mutiLang langKey="system.version.number"/>  --%><a
            onclick="goHitekInfoFun()" href="javascript:void(0);">重庆海特科技发展有限公司</a>
        </div>
      </div>
    </div>
    <!--右侧部分结束-->
  ...
  <!-- 浮窗导航 -->
  <div id="asidenav-box"></div>
   <!-- <div class="aside-nav bounceInUp animated" style="display:none"  id="aside-nav">
   <label style="display:none" id="aside-nav-label" data-funCode="showFloatNavigator" for="" class="aside-menu" title="按住拖动">菜单</label>
   <a style="display:none"  data-funCode="consignManagement" href="#"  title="委托管理" class="menu-item menu-line menu-first">委托<br>管理</a>
   <a style="display:none"  data-funCode="taskAssignMenu" href="#"  title="任务分配" class="menu-item menu-line menu-second">任务<br>分配</a>
   <a style="display:none"  data-funCode="testTaskMenu" href="#"  title="试验检测" class="menu-item menu-line menu-third">试验<br>检测</a>
   <a style="display:none"  data-funCode="testTaskReviewMenu"  href="#" title="试验复核" class="menu-item menu-line menu-fourth">试验<br>复核</a>
   <a style="display:none"  data-funCode="reportAuditMenu" href="#"  title="报告审核" class="menu-item menu-line menu-fifth">报告<br>审核</a>
   <a style="display:none"  data-funCode="reportApproveMenu" href="#"  title="报告批准" class="menu-item menu-line menu-sixth">报告<br>批准</a>
  </div> -->
  ...
  <script type="text/javascript" src="plug-in/assets/js/asidenav.js"></script>
  <!-- 在线聊天 -->
  ...
  <script>
    ...
    /*   var openUrl = 'onlineExperienceController.do?goUserInfoCollection';
      layerOpenFun(openUrl, '填写信息', ['430px', '404px'], [], '', 'noOpenCallback') */
    }
    // var timeWaitFor = (new Date()).valueOf() + 5 * 60 * 1000;
    var timer = null;
    function userInfoFun() {
      if (!renderContent('userInfoCollection')) {
        var timeWaitFor = (new Date()).valueOf() + 5 * 60 * 1000;
        timer = setInterval(function () {
          var openUrl = 'onlineExperienceController.do?goUserInfoCollection';
          var isOpenObj = { 'isOpen': true }
          $('body iframe').each(function () {
            var srcOpen = $(this).attr('src');
            if (openUrl === srcOpen) {
              isOpenObj.isOpen = false;
            }
          })
          if (isOpenObj.isOpen) {
            layerOpenFun(openUrl, '填写信息', ['430px', '424px'], [], '', 'noOpenCallback')
          }
        }, 5 * 60 * 1000)
      } else {
        clearInterval(timer);
    ...
    funCode('experienceUserInfoCollection', funCodeCallback);
    ...
    function closeCurrentWin() {
      //$("i[class='fa fa-times-circle']",window.parent.document).trigger("click");
      //关闭当前tab
      var tab = $(".J_menuTab.active");
      $(tab).find("i[class='fa fa-times-circle']").trigger("click"); //触发小红×的点击事件
    }
    function refreshMainTab() {
      var loading = layer.load();
      var tab = $(".J_menuTab.active");
      //切换到第一个tab，并刷新，即是首页
      var firstA = $(tab).parent().find("a").get(0);
      var target = $('.J_iframe[data-id="' + $(firstA).data('id') + '"]');
      if (target == undefined) {
      ...
      //调用首页标签刷新表格函数，
      target.get(0).contentWindow.reloadTable();
